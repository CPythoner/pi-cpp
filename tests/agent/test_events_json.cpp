...
TEST_CASE("EvMessageUpdate round-trip：内嵌 AssistantMessageEvent") {
    ...
    CHECK(nlohmann::json(e2) == j);   // 嵌套事件整体 round-trip 语义相等
}
